...
void main() async {
  ...
  // Configure network logger with environments
        ...
        actions: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Icon(
                  _getFlavorIcon(NetworkLoggerConfig.currentFlavor),
                  size: 16,
                  color: _getFlavorColor(NetworkLoggerConfig.currentFlavor),
                ),
                const SizedBox(width: 4),
                Text(
                  NetworkLoggerConfig.currentFlavor,
                  style: TextStyle(
                    color: _getFlavorColor(NetworkLoggerConfig.currentFlavor),
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              // Dashboard info card
              if (NetworkLogger.dashboardUrl != null) ...[
                Card(
                  child: Padding(
                    padding: const EdgeInsets.all(16.0),
                    child: Column(
